  ...
  return [
    ...
    ...(options.emitNextEvents
      ? [
          ...
          '      if (event.properties?.assistantMessageID) nextTextByMessageID.set(event.properties.assistantMessageID, "");',
          '      return;',
          '    }',
          ...
          '      nextTextByMessageID.set(messageID, (nextTextByMessageID.get(messageID) || "") + delta);',
          ...
          '      return;',
          '    }',
          '    if (event.type === "session.next.text.delta" || event.type === "session.next.text.ended") return;'
        ]
      : []),
